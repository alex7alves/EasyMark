...
public class TCadFuncionarioDono extends javax.swing.JFrame {
    ...
    public TCadFuncionarioDono(String log) throws ClassNotFoundException {
        initComponents();
    ...
    public TCadFuncionarioDono(int ev,String log) throws ClassNotFoundException {
        initComponents();
        this.setLocationRelativeTo(null);
        c = ConectaBd.Conectabd();
        login = log;
    ...
    private TCadFuncionarioDono() throws ClassNotFoundException {
...
// throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public void cadastrarFuncionario(){
        ...
        try{
            ...
            s.setString(19, txttipo.getText());
            s.executeUpdate();
...
public void EditarFuncionario() {
     String csql = "Update \"Funcionario\" set nome=?,rua=?,numero=?,bairro=?,"
        ...
        try{
            ...
            s.setString(18,txttipo.getText());
            s.executeUpdate();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       cadastrarFuncionario();
        try {
            ...
            Logger.getLogger(TCadFuncionarioDono.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new TCadFuncionarioDono().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(TCadFuncionarioDono.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    protected javax.swing.JTextField txttipo;
